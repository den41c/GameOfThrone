...
namespace Assets.GameLogic.LandsProperties
{
	...
	public class KingsForest : ILand
	{
		...
		public Vector3 UnitPosition { get { return new Vector3(1492.4f, 9f, 696.8f); } }
	}
	...
	public class KingsLanding : ILand
	{
		...
		public Vector3 UnitPosition { get { return new Vector3(1404.9f, 9f, 639.4f); } }
	}
	...
	public class StormsEnd : ILand
	{
		...
		public Vector3 UnitPosition { get { return new Vector3(1557.8f, 9f, 739.9f); } }
	}
}
